# Chatbot tutor socrático

Aplicación web que utiliza el conocimiento incorporado de un modelo de IA para actuar como **tutor educativo socrático**, guiando al estudiante para que descubra la respuesta por sí mismo, en lugar de dársela de inmediato.

---

## ¿Qué hace?

- Solicita un tema de estudio como base de la conversación.
...
2. **Indicar el tema (obligatorio):**
   - Escribe el tema que deseas estudiar.
   - Pulsa **“Comenzar”**. El tutor utilizará su conocimiento incorporado sobre ese tema.
...
El botón **🤖 Descargar Chatbot** genera un archivo HTML independiente que **contiene el tema, los avatares y el tutor socrático embebidos**.
...
- **“Indica un tema de estudio para comenzar”**: escribe un tema y pulsa **Comenzar** antes de enviar mensajes.
- **El tutor no responde**: revisa tu conexión; el error se muestra en el chat.
- **Respuestas fuera de tema**: el tutor solo responde sobre el tema seleccionado; si preguntas algo ajeno, responderá `[FUERA_DE_ALCANCE]`.
